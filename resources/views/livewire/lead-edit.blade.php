<div class="bg-slate-200">
    <div class="container px-5 py-8">
        <h3 class="font-bold text-lg mb-4">Update Lead</h3>
        ...
        @foreach($notes as $note)
            <div class="mb-4 border border-gray-50 p-4">
                {{ $i++ }} - {{$note->description}}
            </div>
        @endforeach
        ...
        <form wire:submit.prevent="addNote">
            <div class="mb-4">
                <textarea wire:model.lazy="note" class="lms-input" placeholder="Type note" required></textarea>
            </div>
